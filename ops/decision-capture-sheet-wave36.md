...
| D-02 | `ScheduledClosure+Sentinel` \| `MonitorOnly` | `ops/decision-quickfill-card-wave32.md`; `ops/r005-regression-sentinel-wave25.md`; `ops/r005-health-checkpoint-wave33.md`; `ops/packet-doc-lint-checklist-v1.md` |
