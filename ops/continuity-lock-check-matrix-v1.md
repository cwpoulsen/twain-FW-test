...
| AI acquisition timing | AI seed/system first acquired in first scene (opening extraction); databank later adds training/provenance | B1/B2 | `canon/continuity-patch-wave3-v1.md`, `timeline/master-timeline-sequence-v1.md`, `canon/canon-ledger-v2.md` | Databank raid described as first acquisition | P0 |
...
| Fabrication ladder | Class 4/3 distributed base -> Blackfly constrained Class 2 -> Asterion fragile Class 1 | E1/E2 | `tech/technical-architecture-v1.md`, `tech/fabricator-classes.md`, `canon/canon-ledger-v2.md` | Taxonomy drift or capability inflation | P0/P1 |
